...
public class MainWindowController {
	...
	public void stopProgram(){
		 ...
		 * System.exit() wäre eine Alternative !!es gibt dann aber keine Möglichkeit 
		 * auf das Aufrufen von stop()!!
		 * 
		 */
		Platform.exit();
	}

	@FXML public void handleSearchDoc(){
	/**
	 * Kk 170223
	 * KK, CB 170224
	 * Dialog zur Dateiauswahl aufrufen *erledigt
	 * Dateiname im Label anzeigen		*erledigt
	 * ausgewählte Datei im Image anzeigen
	 * 	 */
